...
struct Settings {
    ...
    struct Messages {
        ...
        // static let SeaMonster = "Whoa Nessie!"
        static let HumanHitMonster = "🐳You've Awakened A SeaMONSTER! This GIANT Marine reptile is comin' for you SHIPS!🐳"
        static let ComputerHitMonster = "🐳The Computer have Awakened A SeaMONSTER! This GIANT Marine reptile is going for computer's SHIPS!🐳"
